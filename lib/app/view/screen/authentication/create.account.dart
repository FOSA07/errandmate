                    ...
                    child: Column(
                      children: [
                        ...
                        AppTextFormField(
                          ...
                          keyboardType: TextInputType.name,
                          validator: validateName,
                          onChanged: (p0) => accountForm.updateLastname(p0.trim()),
                        ),
                        const SizedBox(height: 20,),
                        AppTextFormField(
                          ...
                          onChanged: (p0) => accountForm.updateUsername(p0.trim()),
                        ),
                        const SizedBox(height: 20,),
                        DropDownField(
                          labelText: "Gender",
                          ...
                          onChanged: (p0) => accountForm.updateGender(p0.name.toString().trim()),
                        ),
                        const SizedBox(height: 20,),
                        AppTextFormField(
                          controller: _matric,
                          ...
                          onChanged: (p0) => accountForm.updateMatricNumber(p0.trim()),
                        ),
                        const SizedBox(height: 20,),
                        AppTextFormField(
                          controller: _email,
                        ...
                        Consumer(
                          builder: (context, ref, child) {
                            ...
                            final institutionData = ref.read(institutionNotifierProvider.notifier).getInstitutions;

                            return DropDownField(
                              hintText: 'Institution',
                              labelText: 'Institution',
                              dropDownValueModel: 
                                institutionData!.map((institutionMap) => 
                                  {
                              ...
                              onChanged: (value) {
                                ...
                                if (value.toString().isNotEmpty) {
                                  DropDownValueModel dropDownValue = value as DropDownValueModel;
                                  var map = dropDownValue.value;

                                  accountForm.updateInstitution(map.id.toString());

                                  ref.read(facultyNotifierProvider.notifier).fetchFaculties(
                                    instId: map.id,
                                    facId: '1'
                                  );
                                  ...
                                  ref.refresh(facultyNotifierProvider.notifier).resetFaculties();
                                }
                        ...
                        Consumer(
                          ...
                          builder: (context, ref, child) {
                            final facultyWatcher = ref.watch(facultyNotifierProvider);
                            ...
                            return DropDownField(
                              ...
                              dropDownValueModel: 
                                ref.watch(facultyNotifierProvider.notifier).getFaculties
                                  .map((facultyMap) => {
                              ...
                              onChanged: (value) {
                                ...
                                if (value.toString().isNotEmpty) {
                                  ...
                                  ref.read(departmentNotifierProvider.notifier).fetchDepartments(
                                    instId: map.instId,
                                  ...
                                  ref.refresh(departmentNotifierProvider.notifier).resetDepartments();
                                }
                        ...
                        Consumer(
                          builder: (context, ref, child) {
                            final departmentWatcher = ref.watch(departmentNotifierProvider);

                            return DropDownField(
                              hintText: 'Department',
                              labelText: 'Department',
                              isLoading: departmentWatcher.isLoading,
                              dropDownValueModel: ref.watch(departmentNotifierProvider.notifier).getDepartments
                                  .map((departmentMap) => {
                        ...
                        ValueListenableBuilder(
                          ...
                          builder: (context, value, child) => AppTextFormField(
                              ...
                              onChanged: (p0) => accountForm.updatePassword(p0.trim()),
                            )
                        ),
                        const SizedBox(height: 20,),
                        ValueListenableBuilder(
                          ...
                          builder: (context, value, child) => AppTextFormField(
                              ...
                              validator: (p0) => _confirmPassword.text.isEmpty ?
              ...
              AppActionButton(
                ...
                onPressed: () async {
                  if(_formKey.currentState!.validate()){
                    ref.read(createUserAccountNotifierProvider.notifier).createUser();
                  }
                },
